      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: widget.isPassword
              ...
              : null,
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(6), borderSide: BorderSide(width: 1.5)),
          enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide(width: 1)),
          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide(width: 1.0)),
        ),
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: widget.prefixWidget != null
              ? Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 8),
                  child: IconTheme(
                    data: IconThemeData(color: iconColor), // ✅ prefix icon color
                    child: widget.prefixWidget!,
                  ),
                )
              : null,
