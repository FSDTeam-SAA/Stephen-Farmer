...
class DocumentCategoryCard extends StatelessWidget {
  const DocumentCategoryCard({super.key, required this.item, this.onTap});
        ...
        child: Column(
          ...
          children: [
            Container(
              height: 48,
              width: 48,
              decoration: BoxDecoration(color: const Color(0xFFE6E5DD), borderRadius: BorderRadius.circular(8)),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(8),
                child: Image.asset(_resolveIconAsset(item.type), fit: BoxFit.fill),
              ),
            ),
