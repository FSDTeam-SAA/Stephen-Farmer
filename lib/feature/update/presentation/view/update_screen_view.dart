...
class UpdateScreenView extends StatelessWidget {
  ...
  String? _resolvePreviewImageUrl(String item, List<UpdateModel> updates) {
    ...
    return _categoryThumbnailUrls[item.trim().toLowerCase()] ?? _categoryThumbnailUrls["default"];
  }
                            ...
                            children: [
                              if (controller.shouldShowCategoryDropdown)
                                CategoryDropdownWidget<String>(
                                  ...
                                  onSelect: (index) => controller.selectCategory(items[index]),
                                  titleBuilder: (item) => item,
                                  subtitleBuilder: (item) => _resolveUpdatePreview(item, controller.updateList).title,
                                  thumbnailBuilder: (item) => _resolvePreviewImageUrl(item, controller.updateList),
                                          ...
                                          children: [
                                            CircleAvatar(
                                              child: Icon(
                                                ...
                                                size: 18,
                                                color: isInterior ? const Color(0xFF2E2E2E) : Colors.grey.shade300,
                                              ),
                                            ),
                              ...
                              Expanded(
                                child: filteredList.isEmpty
                                    ...
                                    : ListView.builder(
                                        ...
                                        itemBuilder: (_, index) {
                                          return UpdatePostCard(item: filteredList[index], isInteriorTheme: isInterior);
                                        },
                                      ),
                              ),
                            ],
